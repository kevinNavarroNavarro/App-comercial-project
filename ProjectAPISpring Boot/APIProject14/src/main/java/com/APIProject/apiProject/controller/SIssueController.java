...
public class SIssueController {
    ...
    public SIssueDTO.Response save( @RequestBody SIssueDTO.Request sIssue) {
        return converter.toResponse(service.save(converter.fromRequest(sIssue)));
    }

    @RequestMapping(path = "/{id}", method = RequestMethod.PUT)
    public SIssueDTO.Response update( @PathVariable(value = "id", required = false) String id,
    ...
    public List<SIssueDTO.Response> findAll() {
